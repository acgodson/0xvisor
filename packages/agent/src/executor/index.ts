...
import type { Adapter, ProposedTransaction, AdapterContext } from "../adapters/types.js";
...
export class Executor {
  ...
  async executeAdapter(input: ExecuteInput) {
    ...
    const proposedTx: ProposedTransaction | null = await adapter.proposeTransaction(adapterContext);
