...
type loaderContext = {
  ...
  @as("DisabledDelegation") disabledDelegation: entityLoaderContext<Entities.DisabledDelegation.t, Entities.DisabledDelegation.indexedFieldOperations>,
  @as("EnabledDelegation") enabledDelegation: entityLoaderContext<Entities.EnabledDelegation.t, Entities.EnabledDelegation.indexedFieldOperations>,
  @as("Redemption") redemption: entityLoaderContext<Entities.Redemption.t, Entities.Redemption.indexedFieldOperations>,
  @as("Stats") stats: entityLoaderContext<Entities.Stats.t, Entities.Stats.indexedFieldOperations>,
}
...
type handlerContext = {
  ...
  effect: 'input 'output. (Envio.effect<'input, 'output>, 'input) => promise<'output>,
  chains: Internal.chains,
  @as("DisabledDelegation") disabledDelegation: entityHandlerContext<Entities.DisabledDelegation.t>,
  @as("EnabledDelegation") enabledDelegation: entityHandlerContext<Entities.EnabledDelegation.t>,
  @as("Redemption") redemption: entityHandlerContext<Entities.Redemption.t>,
  @as("Stats") stats: entityHandlerContext<Entities.Stats.t>,
}

//Re-exporting types for backwards compatability
@genType.as("DisabledDelegation")
type disabledDelegation = Entities.DisabledDelegation.t
@genType.as("EnabledDelegation")
type enabledDelegation = Entities.EnabledDelegation.t
@genType.as("Redemption")
type redemption = Entities.Redemption.t
@genType.as("Stats")
type stats = Entities.Stats.t
...
let abi = Ethers.makeAbi((%raw(`[{"type":"event","name":"DisabledDelegation","inputs":[{"name":"delegationHash","type":"bytes32","indexed":true},{"name":"delegator","type":"address","indexed":true},{"name":"delegate","type":"address","indexed":true}],"anonymous":false},{"type":"event","name":"EnabledDelegation","inputs":[{"name":"delegationHash","type":"bytes32","indexed":true},{"name":"delegator","type":"address","indexed":true},{"name":"delegate","type":"address","indexed":true}],"anonymous":false},{"type":"event","name":"RedeemedDelegation","inputs":[{"name":"rootDelegator","type":"address","indexed":true},{"name":"redeemer","type":"address","indexed":true}],"anonymous":false}]`): Js.Json.t))
let eventSignatures = ["DisabledDelegation(bytes32 indexed delegationHash, address indexed delegator, address indexed delegate)", "EnabledDelegation(bytes32 indexed delegationHash, address indexed delegator, address indexed delegate)", "RedeemedDelegation(address indexed rootDelegator, address indexed redeemer)"]
@genType type chainId = [#11155111]
let contractName = "DelegationManager"

module RedeemedDelegation = {

let id = "0x6c2c51224ed820311568a004ef709463ac30353716689510e2967b60220a2c49_3"
let sighash = "0x6c2c51224ed820311568a004ef709463ac30353716689510e2967b60220a2c49"
let name = "RedeemedDelegation"
let contractName = contractName

@genType
type eventArgs = {rootDelegator: Address.t, redeemer: Address.t}
@genType
type block = Block.t
@genType
...
let paramsRawEventSchema = S.object((s): eventArgs => {rootDelegator: s.field("rootDelegator", Address.schema), redeemer: s.field("redeemer", Address.schema)})
...
let register = (): Internal.evmEventConfig => {
  let {getEventFiltersOrThrow, filterByAddresses} = LogSelection.parseEventFiltersOrThrow(~eventFilters=handlerRegister->EventRegister.getEventFilters, ~sighash, ~params=["rootDelegator","redeemer",], ~topic1=(_eventFilter) => _eventFilter->Utils.Dict.dangerouslyGetNonOption("rootDelegator")->Belt.Option.mapWithDefault([], topicFilters => topicFilters->Obj.magic->SingleOrMultiple.normalizeOrThrow->Belt.Array.map(TopicFilter.fromAddress)), ~topic2=(_eventFilter) => _eventFilter->Utils.Dict.dangerouslyGetNonOption("redeemer")->Belt.Option.mapWithDefault([], topicFilters => topicFilters->Obj.magic->SingleOrMultiple.normalizeOrThrow->Belt.Array.map(TopicFilter.fromAddress)))
  {
    ...
    convertHyperSyncEventArgs: (decodedEvent: HyperSyncClient.Decoder.decodedEvent) => {rootDelegator: decodedEvent.indexed->Js.Array2.unsafe_get(0)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, redeemer: decodedEvent.indexed->Js.Array2.unsafe_get(1)->HyperSyncClient.Decoder.toUnderlying->Utils.magic, }->(Utils.magic: eventArgs => Internal.eventParams),
    id,
  name,
  contractName,
...
let id = "0x18e6c6b07268aca161793641b75c5e6e9c229c8b968d71da55c594d330d96b7d_4"
let sighash = "0x18e6c6b07268aca161793641b75c5e6e9c229c8b968d71da55c594d330d96b7d"
